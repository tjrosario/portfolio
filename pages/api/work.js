const WORK = [
  {
    description:
      'Algolia-powered search engine built with React and NextJS that searches both blog articles and doula service providers.',
    id: 1,
  ...
  {
    description:
      'Threadlab is an eco-friendly lifestyle personalization technology that makes it easy to discover the best new products from around the world.',
  ...
  {
    description:
      'Online proofing system tailored for helping SMBs deliver marketing projects efficiently by streamlining reviewing and approving creative content.',
    id: 4,
  ...
  {
    description:
      'A fun little app that allows you to search the Giphy Translate API by supplying a "weirdness" level. You can add any GIFs to your favorites list and generate an average "weirdness score."',
