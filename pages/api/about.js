const ABOUT = [
  "Hello!  I'm a frontend developer based out of the Jersey Shore.  I love working on fun, innovative websites.  I've been involved in technology for almost two decades now.  My journey has given me the pleasure to work with some of the world's most recognized brands including iHeartRadio, Topps, Estee Lauder, Lowes, Virgin Mobile, Citi and many others.  I've also been lucky enough to work along side with some highly talented technologists as my peers, which I have looked to as mentors throughout my career.",
  ...
  'Beyond the keyboard I have a huge passion for music, fitness and the beach!  Family and a healthy work-life balance is key to my happiness.',
