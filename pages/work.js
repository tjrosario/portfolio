...
export default function Work({ data = [] }) {
  ...
  return (
    <Layout pageTitle={'Work Samples'}>
      ...
      <Text>
        This a hand-picked collection of some recent work I've had the pleasure
        of being involved with building. Enjoy!
      </Text>
      ...
      {activeWork && (
        <WorkModal isOpen={isOpen} onClose={onClose} work={activeWork} />
      )}
    </Layout>
  );
}
