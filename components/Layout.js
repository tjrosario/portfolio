    ...
    <>
      <Head>
        ...
        <meta
          name={'keywords'}
          content={
            'frontend, developer, software, engineering, html, css, javascript, react, angular, website'
          }
        />
        <meta name={'description'} content={description} />

        <meta name={'author'} content={'Tommy Rosario'} />

        <meta name={'copyright'} content={'Copyright Tommy Rosario'} />
